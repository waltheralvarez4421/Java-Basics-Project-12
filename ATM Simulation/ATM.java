...
{  
   ...
   private Accounts currentAccountNumber;
   ...
   */
   ...
   public void selectAccountNumber(int accountNumber)
   { 
      currentAccountNumber
         = theBank.findAccount(accountNumber, customerNumber);
   ...
   */
   public void selectAccount(int account)
   {
      if (account == CHECKING)
      {
         currentAccount = currentAccountNumber.getCheckingAccount();
      }
      else
      {
         currentAccount = currentAccountNumber.getSavingsAccount();
      }
      state = TRANSACT;
   }
